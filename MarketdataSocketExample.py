...
Instruments = [
                ...
                {'exchangeSegment': 2, 'exchangeInstrumentID': 35013}
               ]
...
el.on('1510-json-full', on_message1510_json_full)
el.on('1512-json-full', on_message1512_json_full)
el.on('1501-json-partial', on_message1501_json_partial)
el.on('1502-json-partial', on_message1502_json_partial)
el.on('1505-json-partial', on_message1505_json_partial)
el.on('1510-json-partial', on_message1510_json_partial)
